...
// let projectsDom = <div className="flex flex-col gap-32 max-w-6xl mx-auto px-6">
...
export default function Home() {
  ...
  <div className="max-w-3xl mx-auto px-6 flex flex-col items-center gap-2">
    <p className="text-base md:text-lg text-fontprimary text-center">
      Interested in my work? <Link href="/contact" className="underline hover:text-fontsecondary">Contact me</Link>.
    </p>
  </div>
</section>
